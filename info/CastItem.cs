...
namespace DSmithGameCs
{
	public class CastItem : Item
	{
		...
		protected static readonly Matrix4 ItemMatrix = Matrix4.CreateRotationX(0.1f)*Matrix4.CreateRotationY(-0.1f)*Matrix4.CreateTranslation(0, 0, -2.8f)
			*Matrix4.CreatePerspectiveFieldOfView(0.8f, 1, 0.1f, 4);

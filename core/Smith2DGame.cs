...
{
	public class Smith2DGame : EntityEvent
	{
		...
		public void Init ()
		{
			...
			currentScene.AddEntity (new MeshEntity (wallMesh, -15, 0, 0, -0.2f, 0, PI / 2, 1, 20));
			currentScene.AddEntity (new InteractiveEntity (this, new Mesh ("../../res/table.ply"), 5.5f, -8, 0, 7, 4));
			currentScene.AddEntity (new InteractiveEntity (this, new Mesh ("../../res/anvil.ply"), -15 + 9, 9, 0, 8, 3));

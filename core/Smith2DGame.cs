...
namespace DSmithGameCs
{
	public class Smith2DGame
	{
		...
		public Scene MakeSmithScene()
		{
			...
			smithScene.AddEntity (new CastingTableEntity (this, new Mesh (Util.PATH+"res/meshes/house/castingTable.ply"), new Mesh (Util.PATH+"res/mesh/castFill.ply"), new Mesh (Util.PATH+"res/mesh/moltenMetalFall.ply"), 4, -9.5f, 1.55f, 10.25f, 3.3f));

...
namespace DSmithGameCs
{
	public class Smith2DGame
	{
		...
		private void NewGame()
		{
			...
			CurrentScene.AddEntity (new CastingTableEntity (this, new Mesh ("../../res/castingTable.ply"), new Mesh ("../../res/castFill.ply"), new Mesh ("../../res/moltenMetalFall.ply"), -11.5f, -1f, 1.55f, 6.25f, 3.3f));
